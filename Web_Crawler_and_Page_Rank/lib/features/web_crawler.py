...
from lib.encryption.encode import encode_url
...
class WebCrawler:
    def __init__(self, max_links):
        ...
        self.datasetsPath = 'D:\\PycharmProjects\\search_engine\\lib\\datasets'
    ...
    def save_all_links_in_file(self):
        try:
            with open(f'{self.datasetsPath}\\all_links.txt', 'w') as file:
                file.write('\n'.join(self.visited))
